...
function preload() {
  ...
  headImg = loadImage("skeletonimages/skull.png");
  torsoImg = loadImage("skeletonimages/torso.png");
  hipImg = loadImage("skeletonimages/hips.png");
  boneImg = loadImage("skeletonimages/bone.png");
  boneSmallImg = loadImage("skeletonimages/boneSmall.png");
  legLeftImg = loadImage("skeletonimages/leftLeg.png");
  legRightImg = loadImage("skeletonimages/rightLeg.png");
}
